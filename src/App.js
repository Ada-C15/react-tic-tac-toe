...
const App = () => {
  ...
  //conditional (ternary) operator is
  setPlayer(currentplayer===PLAYER_1 ? PLAYER_2 : PLAYER_1);
}
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <h2>Hey {currentplayer}!  It's your turn! </h2>
        <h3>The winner is {checkForWinner()}</h3>
